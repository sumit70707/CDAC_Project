        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-gray-700 leading-relaxed mb-12 font-light">
              ...
              No harsh chemicals, no empty promises—just pure, effective care for the skin you're in. YES SUmit Satish SHELKE Beed, Maharashtra"
            </p>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto font-sans">
            <div className="p-10 border border-gray-100 hover:bg-gray-50 transition-colors">
              ...
              <a href="mailto:trume.skincare@gmail.com" className="text-xl font-bold hover:underline">trume.skincare@gmail.com</a>
            </div>
            <div className="p-10 border border-gray-100 hover:bg-gray-50 transition-colors">
              <div className="text-3xl mb-4">📞</div>
              <h4 className="text-sm font-black uppercase tracking-widest mb-2">Phone</h4>
              <a href="tel:+919325365861" className="text-xl font-bold hover:underline">+91 9325365861</a>
            </div>
          </div>
        </div>
      </div>
